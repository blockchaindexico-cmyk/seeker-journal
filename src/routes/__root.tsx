...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Track every job application in one cinematic workspace: links, platforms, recruiter contacts, follow-ups, interviews and AI-assisted notes.",
      },
